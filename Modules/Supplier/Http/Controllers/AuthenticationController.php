...
use Modules\Supplier\Http\Requests\Authentication\SupplierSignUpRequest;
...
final class AuthenticationController extends Controller
{
    ...
    /**
     * @param SupplierController $objRequest
     * @return JsonResponse
     * @throws BindingResolutionException
     * @throws ContainerExceptionInterface
     * @throws NotFoundExceptionInterface
     */
    public function signUp(SupplierSignUpRequest $objRequest): JsonResponse
    {
        $objUser = $this->objUserService->create($objRequest->getDTO(), UserType::SUPPLIER);
    ...
    public function signIn(SignInRequest $objRequest): JsonResponse
    {
        ...
        if($objUser->role->name != UserType::SUPPLIER->value){
            throw ValidationException::withMessages([
                'email' => ['The provided credentials are incorrect.'],
            ]);
        }
