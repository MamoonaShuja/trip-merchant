...
class RoleRepository implements RoleRepositoryContract
{
    ...
    {
        $objQuery = $this->model->newQuery();
        return $objQuery->whereNotIn("name" , [UserType::ORGANIZER->value, UserType::SUPPLIER->value , UserType::MEMBER->value , UserType::EMPLOYEE->value] )->get();
    }
    ...
    public function getRoleByName(string $strName):string|null{
        $objQuery = $this->model->newQuery();
        return $objQuery->whereName($strName)->first()->id;
    }
